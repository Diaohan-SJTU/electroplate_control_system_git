//
// Created by A on 2022/5/28.
//

#ifndef V1_DATA_LOG_H
#define V1_DATA_LOG_H
...
{
public:
    DataLog(string strDir = "log",string filename = "record",int maxfilesize=0,int filecount=0,int timeformat=0);
    ~DataLog();
